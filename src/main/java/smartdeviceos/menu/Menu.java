...
public class Menu {
    ...
    public List<MenuItem> getParentMenuItems() { return parentMenuItems; }
    public void setParentMenuItems(List<MenuItem> parentMenuItems) { this.parentMenuItems = parentMenuItems; }
